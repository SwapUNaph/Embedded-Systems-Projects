...
void setup() {
    ...
    if (devStatus == 0) {
       ...
       Serial.println(F("DMP ready! Waiting for first interrupt..."));
        ...
        // 2 = DMP configuration updates faild
...
//  attachInterrupt(digitalPinToInterrupt(interruptPin), calculateOmega, RISING);
//     
//*****************************************************************
...
//**********************PID*******************************
        ...
        if(motorSpeed>0 && motorSpeed<deadBand)
            motorSpeed += deadBand;
        else if(motorSpeed>-deadBand && motorSpeed<0)
            motorSpeed -= deadBand;
          if(motorSpeed>=0)
